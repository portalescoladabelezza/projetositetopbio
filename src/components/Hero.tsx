...
import { ArrowRight, Sparkles, CheckCircle2, Phone, Instagram, Facebook, ShieldCheck, Star } from "lucide-react";
          ...
          <div className="lg:col-span-7 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-4 w-full h-full relative">
            ...
            >
              <div className="w-full flex items-center justify-between mb-4 border-b border-white/5 pb-3">
                ...
                <span className="text-[11px] text-gray-500 font-mono tracking-wide truncate max-w-[180px]">preview-celular-ao-vivo.html</span>
              ...
              <div className="w-full max-w-[270px] sm:max-w-[310px] rounded-[30px] border-[6px] border-[#0A0A0A] bg-[#0A0A0A] overflow-hidden aspect-[9/19] flex flex-col glow-gold relative">
                ...
                <div className="flex-1 overflow-y-auto no-scrollbar pt-5 px-3 pb-3 space-y-3.5 text-center text-white">
                  {/* Simulated URL Bar */}
                  <div className="w-full bg-[#151515] rounded-full px-2.5 py-1 text-[9px] text-gray-500 font-mono flex items-center justify-between border border-white/5 mt-2">
                    <span className="truncate">seusiteprofissional.com.br</span>
                    <span className="text-emerald-500 shrink-0 font-bold text-[8px]">✓ Secured</span>
                  </div>

                  {/* Profile Mock */}
                  <div className="flex flex-col items-center space-y-2 pt-1">
                    <div className="w-12 h-12 rounded-full bg-gradient-to-tr from-gold-600 to-gold-400 p-[1.5px]">
                      <div className="w-full h-full rounded-full bg-[#1C1C1C] flex items-center justify-center font-display text-xs font-extrabold text-[#D4AF37]">
                        MN
                      </div>
                    </div>
                    <div>
                      <h4 className="text-xs font-bold font-display flex items-center justify-center gap-1 text-white">
                        Meu Negócio Oficial
                        <span className="w-3 h-3 rounded-full bg-blue-500 flex items-center justify-center text-[7px] text-white">✓</span>
                      </h4>
                      <p className="text-[10px] text-gray-400 leading-snug max-w-[180px] mx-auto">
                        Prestação de Serviços com Visual Premium.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center justify-center gap-2.5 py-0.5">
                    <div className="bg-[#151515] text-gray-300 p-1.5 rounded-full border border-white/5 shadow-md">
                      <Instagram size={11} />
                    </div>
                    <div className="bg-[#151515] text-[#25D366] p-1.5 rounded-full border border-white/5 shadow-md">
                      <Phone size={11} fill="currentColor" />
                    </div>
                    <div className="bg-[#151515] text-blue-500 p-1.5 rounded-full border border-white/5 shadow-md">
                      <Facebook size={11} />
                    </div>
                  </div>

                  {/* Premium buttons inside phone */}
                  <div className="space-y-2 pt-1">
                    <button className="w-full bg-[#151515] text-white hover:text-[#D4AF37] border border-white/5 text-[10px] p-2.5 rounded-xl flex items-center justify-between shadow-md transition-colors cursor-pointer group">
                      <span className="flex items-center gap-1.5">
                        <span className="w-4 h-4 rounded-md bg-[#25D366]/20 text-[#25D366] flex items-center justify-center text-[9px]">💬</span>
                        Fale Comigo no WhatsApp
                      </span>
                      <ArrowRight size={8} className="text-gray-400 group-hover:text-[#D4AF37] transition-colors" />
                    </button>

                    <button className="w-full bg-[#151515] text-white hover:text-[#D4AF37] border border-white/5 text-[10px] p-2.5 rounded-xl flex items-center justify-between shadow-md transition-colors cursor-pointer group">
                      <span className="flex items-center gap-1.5">
                        <span className="w-4 h-4 rounded-md bg-[#D4AF37]/20 text-[#D4AF37] flex items-center justify-center text-[9px]">⭐</span>
                  ...
                  {/* Inside offer highlight */}
                  <div className="bg-[#151515] border border-white/5 p-2 rounded-xl text-center">
                    <p className="text-[8px] text-[#D4AF37] font-semibold tracking-wide uppercase">Oferta Ativa</p>
                    <p className="text-[11px] text-white font-bold mt-0.5">{PRICE_INSTALLMENT}</p>
                  </div>
                </div>
